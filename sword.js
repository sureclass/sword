        ...
        if(type=="main_msg"){//out2
            try{
                ...
                if(xuanhongboolean == 1){
                    ...
                    if(y){
                        g_gmain.recvNetWork2("开始查找......");
                        for(let i in npcdplist[y[1]]){
                            if(npcdplist[y[1]][i].indexOf(y[2])>=0){
                                //这个i(npc名)就是我们要对话的,调用导航仪走过去
                                go(npcdp[y[1]][i]);
                                let str_wz = i+npcdp[y[1]][i];
                        ...
                        //数据没有找到，我们重新接
                        g_gmain.recvNetWork2("没找到此人，元宝取消重新接取");
